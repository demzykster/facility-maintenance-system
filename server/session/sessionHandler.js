...
export function buildSessionPayload(authUser, profile) {
  ...
  return {
    ...
    user: {
      ...
      depts: appUser.departments?.length ? appUser.departments : (appUser.department ? [appUser.department] : []),
      department: appUser.department,
      departments: appUser.departments,
      mgrZones: appUser.mgrZones,
      techScope: appUser.techScope,
...
export function buildCmmsPinSessionPayload(tokenSession, storedUser) {
  ...
  return {
    ...
    user: {
      ...
      dept: storedUser.dept || storedUser.department || "",
      depts: Array.isArray(storedUser.depts) ? storedUser.depts : (Array.isArray(storedUser.departments) ? storedUser.departments : (storedUser.dept ? [storedUser.dept] : [])),
      ...
      perms: storedUser.perms || storedUser.permissions || {},
