...
### Active branch: codex/pwa-install-prompt-copy

- Status: PWA login install prompt copy/desktop behavior is in progress as a small UI polish branch. Continue with owner-facing UI/data-confidence bugs or the next final pilot polish item after this branch is merged.
