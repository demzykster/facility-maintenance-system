...
- Production bundle is still above Vite's default 500 kB raw/minified chunk warning. On 2026-07-10, `npm run build` produced the main app chunk at 1,945.42 kB raw / 494.30 kB gzip, plus lazy chunks for Excel/CSV import, QR scanning/printing, and Excel export. This is improved from the previous 2,208.37 kB raw / 580.14 kB gzip main chunk, but it remains a real raw-size warning.
