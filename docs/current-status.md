...
- `npm test` is available. As of 2026-07-10 on the settings-records authority branch, it runs 168 test files / 825 tests.
...
- CI now runs `npm run lint`, a lightweight JS/MJS syntax gate built on `node --check`; on 2026-07-10 it checked 374 files. JSX coverage still comes from `npm run build`.
