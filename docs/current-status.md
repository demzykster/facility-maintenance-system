...
- Technician/user presence is normalized-authority in production/API mode through `/api/presence`; production/API saves no longer create new `presence:*` KV mirrors, and staging has retired all matched `presence:*` KV mirrors.
