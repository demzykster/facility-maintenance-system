...
- Production bundle is still above Vite's default 500 kB raw/minified chunk warning. On 2026-07-13, `npm run build` produced the main app chunk at 1,036.89 kB raw / 259.21 kB gzip, plus lazy chunks for Excel/CSV import/export, QR scanning/printing, notifications, AI, settings/team management, suppliers, activity log, PPE dashboards/orders, management tasks/meetings, admin ticket lists, app issue settings, and ticket detail. This is improved from the previous 2,208.37 kB raw / 580.14 kB gzip main chunk, but it remains a real raw-size warning.
