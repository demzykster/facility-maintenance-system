...
- Production bundle is still above Vite's default 500 kB chunk warning. On 2026-07-10, `npm run build` produced the main app chunk at 2,208.03 kB raw / 580.03 kB gzip. This is expected for the current monolith and is not a blocker, but it remains a real size warning.
