...
- Tickets are managed through `/api/tickets`; normalized `tickets` is the production/API-mode authority, and production/API saves no longer create new `ticket:*` KV mirrors.
