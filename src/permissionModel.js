...
export const USER_PERMISSION_MODULES = [
  ...
  { mod: "userGroups", label: "קבוצות ארגוניות", levels: ["none", "view", "manage"], hint: "צפייה או ניהול קבוצות כמו ועדת בטיחות, צוות חירום, נאמני בטיחות וצוות איכות. קבוצה אינה תפקיד מערכת." },
  { mod: "controls", label: "בקרות", levels: ["none", "view", "request", "manage", "full"], hint: "צפייה, ביצוע וניהול בקרות. בקשה/ביצוע — ביצוע סבב שהוקצה; ניהול — תכניות, שיוכים ומעקב; מלא — הגדרות רגישות ודוחות עתידיים." },
