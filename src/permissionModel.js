...
export const USER_PERMISSION_MODULES = [
  ...
  { mod: "aiAutonomousTicketCreate", label: "AI autonomous transport ticket create", levels: ["none", "request"], hint: "גישה מאושרת לפתיחת קריאת שינוע אוטונומית על ידי AI. עובד רק כשדגל השרת הגלובלי פעיל." }
];
